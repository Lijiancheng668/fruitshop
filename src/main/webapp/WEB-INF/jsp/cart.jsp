        ...
        <div class="row" id="cart_table_div">
            <table id="cart_table" border="0" cellpadding="0" cellspacing="0">
                ...
                <c:forEach items="${cart.cartItems}" var="cartItem">
                    ...
                    <tr class="cart_item" id="cart_item${cartItem.value.fruitInfo.fruitId}">
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${cartItem.value.fruitInfo.storeId}号店铺</td>
                        <td class="tcol1" hidden="hidden">
                            <input type="checkbox" ${cartItem.value.checked?'checked':''}
                                   onchange="checkOrNot(${cartItem.value.fruitInfo.fruitId},${cartItem.value.fruitInfo.price},this)"
                                   class="shop_checkbox" />
                        </td>
                        <td>
                            <a href="#"><img src="${cartItem.value.fruitInfo.imageUrl}" width="20%"/></a>
                            <span>${cartItem.value.fruitInfo.name}</span>
                        </td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="red">￥<fmt:formatNumber type="number" value="${cartItem.value.fruitInfo.price}"
                                                                 pattern="0.00"/></span>
                        </td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="javascript:void(0);"
                               onclick="deleteCartItem(${cartItem.value.fruitInfo.fruitId})">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                <tr class="tfoot">
